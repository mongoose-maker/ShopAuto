...
describe('ManufacturerController - E2E Tests', () => {
    ...
    describe('GET /api/manufacturers', () => {
        it('должен получить всех производителей', async () => {
            ...
            expect(response.body.some((m) => m.name === 'Manufacturer 1')).toBe(true);
            expect(response.body.some((m) => m.name === 'Manufacturer 2')).toBe(true);
        });
...
//# sourceMappingURL=ManufacturerController.e2e.test.js.map