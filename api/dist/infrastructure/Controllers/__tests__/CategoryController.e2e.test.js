...
describe('CategoryController - E2E Tests', () => {
    ...
    describe('GET /api/categories', () => {
        it('должен получить все категории', async () => {
            ...
            expect(response.body.some((c) => c.name === 'Category 1')).toBe(true);
            expect(response.body.some((c) => c.name === 'Category 2')).toBe(true);
        });
...
//# sourceMappingURL=CategoryController.e2e.test.js.map