...
export function createOrderItemRouter(controller) {
    const router = Router();
    router.post("/order-items", validateDto(AddOrderItemDto), controller.createOrderItem.bind(controller));
    ...
    router.put("/order-items/:id", validateDto(UpdateOrderItemDto), controller.updateOrderItem.bind(controller));
...
//# sourceMappingURL=OrderItemRotes.js.map