...
export function createOrderRouter(controller) {
    const router = Router();
    router.post('/orders', validateDto(AddOrderDto), controller.createOrder.bind(controller));
    router.get('/orders/:id', controller.getOrderById.bind(controller));
    router.get('/users/:userId/orders', controller.getOrdersByUserId.bind(controller));
    router.put('/orders/:id', validateDto(UpdateOrderDto), controller.updateOrder.bind(controller));
