...
describe('ProductService - Integration Tests', () => {
    ...
    beforeAll(async () => {
        ...
        productService = new ProductService(productRepository, manufacturerRepository, categoryRepository);
        // Создаем тестовые данные
        testManufacturer = await manufacturerRepository.addManuf(new Manufacturer(undefined, 'Test Manufacturer', 'Test Description'));
...
//# sourceMappingURL=ProductService.integration.test.js.map