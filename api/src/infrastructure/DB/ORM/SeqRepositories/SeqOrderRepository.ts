...
import { OrderMapper, type SeqOrderWithRelations } from '../../Mapper/MapperOrder.js';
...
export class SeqOrderRepository implements OrderRepository {
  async save(order: Order): Promise<Order> {
    ...
    return OrderMapper.toDomain(orderWithItems.get({ plain: true }) as SeqOrderWithRelations);
  }
  ...
  async findById(id: string): Promise<Order | null> {
    ...
    return OrderMapper.toDomain(order.get({ plain: true }) as SeqOrderWithRelations);
  }
  ...
  async update(order: Order): Promise<Order> {
    ...
    return OrderMapper.toDomain(updatedOrder.get({ plain: true }) as SeqOrderWithRelations);
  }
