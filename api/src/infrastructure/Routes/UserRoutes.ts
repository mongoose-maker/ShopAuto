...
export function createUserRouter(controller: UserController): Router {
  ...
  router.post('/users', validateDto(AddUserDto), controller.createUser.bind(controller));

  router.get('/users/:id', controller.getUserById.bind(controller));

  router.put('/users/:id', validateDto(UpdateUserDto), controller.updateDataUser.bind(controller));
