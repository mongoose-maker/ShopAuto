...
describe('ProductController - E2E Tests', () => {
  ...
  beforeAll(async () => {
    ...
    testManufacturer = await manufacturerRepository.addManuf(
      new Manufacturer(undefined, 'E2E Test Manufacturer', 'E2E Test Description'),
    );

    testCategory = await categoryRepository.addCategory(
      new Category(undefined, 'E2E Test Category'),
    );
  });
