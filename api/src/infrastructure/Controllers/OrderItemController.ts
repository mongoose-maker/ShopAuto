...
export class OrderItemController {
  ...
  async createOrderItem(req: Request, res: Response): Promise<void> {
    try {
      ...
      const dto: AddOrderItemDto = req.body;
  ...
  async updateOrderItemQuantity(req: Request, res: Response): Promise<void> {
    try {
      ...
      const updatedItem = await this.orderItemService.updateOrderItemQuantity(
        orderId,
        productId,
        quantity
      );
  ...
  async updateOrderItem(req: Request, res: Response): Promise<void> {
    try {
      ...
      const dto: UpdateOrderItemDto = req.body;
